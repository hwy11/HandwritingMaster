...
Page({
  ...
  onLoad: function() {
    this.setData({
      ...
      resultPdf: app.globalData.resultPdf || ''
    });
  ...
  showExportOptions: function() {
    this.setData({
      isShowExportOptions: !this.data.isShowExportOptions
    });
  },
  ...
  updateSelectedExportName: function() {
    const format = this.data.exportOptions.find(item => item.id === this.data.selectedExport);
    this.setData({
      selectedExportName: format ? format.name : '未知格式'
    });
  },
});
